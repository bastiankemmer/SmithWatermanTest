...
public class SimpleChaining {
    ...
    public static Comparator FROMA_COMPARATOR = new Comparator() {
        public int compare(Object o1, Object o2) {
            return ((Match) o1).getFromA() - ((Match) o2).getFromA();
        }
    };
    ...
    /*   List matches = new ArrayList();
	   ...
	   */
        try {
            ...
            if (sequence1.length() == 0) sequence1 = "bettybitter";
            if (sequence2.length() == 0) sequence2 = "peterpiper";
            // compute and output the score and alignments
            //SmithWaterman sw = new SmithWaterman(str1, str2);
            SmithWaterman sw = new SmithWaterman(sequence1, sequence2);
            sw.printDPMatrix();
            List<Match> ms = sw.getMatches();
