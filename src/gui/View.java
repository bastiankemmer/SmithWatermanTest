...
public class View {
    ...
    private TextArea sequence1;
    private TextArea sequence2;
    ...
    //Getter Methoden
    public TextArea getSequence1() {
        return sequence1;
    }

    public TextArea getSequence2() {
        return sequence2;
    }
    ...
    {
        Alert alert = new Alert(Alert.AlertType.WARNING, "Ok dr?cken und neu versuchen", ButtonType.OK);
